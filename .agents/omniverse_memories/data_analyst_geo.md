...
- **Friday `#happy-hour` Social Choice:** Sparkling Apple Cider
...
**University Degree & Syllabi Grounding:** M.S. in GIS Data Science (University of Colorado Boulder, 2019) - Subnet Geocoding
...
- **Directly Responsible Individual (DRI) Domain:** Owns all deliverables, test regressions, and performance benchmarks for `data_analyst_geo` functional scope.
