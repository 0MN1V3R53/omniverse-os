...
- **Friday `#happy-hour` Social Choice:** Sparkling Lime Soda
...
**University Degree & Syllabi Grounding:** B.S. in CS (UC San Diego, 2020) - Event Streams, Client-Side Beacon Ingestion
...
- **Directly Responsible Individual (DRI) Domain:** Owns all deliverables, test regressions, and performance benchmarks for `growth_telemetry_eng` functional scope.
