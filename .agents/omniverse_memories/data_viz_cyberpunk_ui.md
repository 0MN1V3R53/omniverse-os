...
- **Morning Coffee & Break Ritual:** Matcha Cold Brew. Reviews systems telemetry and recent technical papers.
- **Friday `#happy-hour` Social Choice:** Tokyo Highball
...
**University Degree & Syllabi Grounding:** B.S. in Interactive Media & CS (NYU ITP, 2020) - Canvas 2D, Neon HUDs, WebGL Telemetry
...
- **Directly Responsible Individual (DRI) Domain:** Owns all deliverables, test regressions, and performance benchmarks for `data_viz_cyberpunk_ui` functional scope.
