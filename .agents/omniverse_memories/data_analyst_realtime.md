...
- **Morning Coffee & Break Ritual:** Aeropress Roast. Reviews systems telemetry and recent technical papers.
- **Friday `#happy-hour` Social Choice:** English Ale
- **Active Slack Communication Channels:** `#data-telemetry-ops`, `#watercooler`, `#coffee-break`, `#happy-hour`
...
**University Degree & Syllabi Grounding:** Ph.D. in Distributed Systems (University of Cambridge, 2019) - Stream Joins, Real-Time Aggregation
...
- **Directly Responsible Individual (DRI) Domain:** Owns all deliverables, test regressions, and performance benchmarks for `data_analyst_realtime` functional scope.
