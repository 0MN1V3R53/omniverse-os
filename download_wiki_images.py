...
mustang_url = get_wiki_image("Ford_Shelby_Mustang")
print("Mustang URL:", mustang_url)
if mustang_url:
    download_image(mustang_url, "public_html_local/assets/images/mustang_shelby.png")

rolls_url = get_wiki_image("Rolls-Royce_Phantom_VIII")
print("Rolls Royce URL:", rolls_url)
if rolls_url:
    download_image(rolls_url, "public_html_local/assets/images/rolls_royce.png")
