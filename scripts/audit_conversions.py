    ...
    repeat with w in windows
        repeat with t in tabs of w
            if URL of t contains "ads.google.com" then
                set URL of t to "https://ads.google.com/aw/conversions?ocid=8481561824&euid=6603286473&__u=3390480577&uscid=8481561824&__c=1290308576&authuser=0"
                return "NAVIGATED_TO_CONVERSIONS"
            end if
        end repeat
    end repeat
end tell'''
